...
std::vector<uint8_t> rawread(const char *filename)
{
	// open the file:
...
bool AudioFile<T>::load(std::string filePath)
{
	...
	std::vector<uint8_t> fileData = rawread(filePath.c_str());
